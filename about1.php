            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">About
                        <strong>Rosem Trucking Services Corporation</strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <p>The ROSEM Trucking Services Corporation is a member of Alliance of Concerned Truck Owners and Organization (ACTOO) and Permit to operate at Philippine Port Authority (PPA) South Harbor.</p><p>
The Rosem Trucking Services Corporation currently have a total of 14 employees. 6 drivers,  6 helpers, 1 dispatcher, 1 office in charge. The corporation have a 6 total of truck unit SUPER GRADE 6M70 CXS 502, ISUZU 8DC10 CXS 492, HINO 750 CXS 484, FUSO8DC9 CXS 490, HINO – 6M70-325912(No Plate Available) 2015 model, FUSO – F21C-A17862 (No Plate Available) 2014 model.</p>
                </div>
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-sm-4 text-center">
                   <center> <img class="img-responsive" src="trucks/justine.jpg" alt="" height="750px" width="400px">
                    <h3>Justine Garcia Francisco
                        <small>BSIT</small>
                    </h3></center>
                </div>
                                <div class="clearfix"></div>
