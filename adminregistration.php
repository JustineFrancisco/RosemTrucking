...
if($username==''){
    ...
    $query="insert into client_info(fname,mname,lname,compname,street,barangay,city,province,email,contact,username,password) values ('$fname','$mname','$lname','$compname','$street','$barangay','$city','$province','$email','$contact','$username','$password')";
