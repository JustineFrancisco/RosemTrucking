...
$limit = 'LIMIT '.($pagenum - 1) * $pageRows.','.$pageRows;
                        $query = "SELECT brandName, partsContent FROM $limit";
                        $sql = mysqli_query($dbc, $query);
...
<?php
include('conn.php');
$sql = "SELECT * FROM tbl_bikes order by dateArrival desc $limit";
         ...
         $price=$list['price'];
              ...
              ?>
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <a href="viewtrucks.php?id=<?php echo $id  ?>" class="btn btn-default btn-lg">Reserve Now!</a>
