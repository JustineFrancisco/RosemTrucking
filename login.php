...
<center height = "30px"><form action="login1.php" method="post">
<table><tr><td><label><b>Username: </b></label></td><td>
<input type="text" placeholder="Enter Username" name="username" required></td></tr><br>

<tr><td><label><b>Password: </b></label></td><td>
<input type="password" placeholder="Enter Password" name="password" required></td></tr>

<tr><td> <a href="registration.php">Register</a></td><td>
