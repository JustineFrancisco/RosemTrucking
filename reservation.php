...
?>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Truck number 1
                    ...
                    <p></p>
                    <a href="truck1.php" class="btn btn-default btn-lg">Reserve Now!</a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Truck number 2
                    ...
                    <p></p>
                     <a href="truck2.php" class="btn btn-default btn-lg">Reserve Now!</a>
                </div>
            </div>
        </div>
  ...
  <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Truck number 3
                       
                    </h2>
                    <hr>
                    <img class="img-responsive img-border img-left" src="img/3.jpg" alt="">
                    <hr class="visible-xs">
                  <p></p>
                       <a href="truck3.php" class="btn btn-default btn-lg">Reserve Now!</a>
