...
<h2 class="intro-text text-center">Reservation Info
          ...
          <form id="form1" name="form1" method="post" action="truck1.php">
...
<tr>
    <td>Time :</td>
    <td><input type="time" name="time" value="" required></td>
</tr>   
...
<input type="hidden" name="hosted_button_id" value="J2NAV4FG63YTL">
...
if($date1 > $date){
    ...
    $quer="SELECT * FROM `reservation` where date='$date' AND truckname = 'Truck1'";
