...
<h2 class="intro-text text-center">Reservation Info
          ...
          <form id="form1" name="form1" method="post" action="truck3.php">
...
<input type="hidden" name="hosted_button_id" value="AKGS9WYHXPMDS">
...
if($date1 > $date){
     ...
     echo "<script>window.open('truck3.php','_self')</script>";
}
else{

    $quer="SELECT * FROM `reservation` where date='$date' AND truckname = 'Truck3'";
